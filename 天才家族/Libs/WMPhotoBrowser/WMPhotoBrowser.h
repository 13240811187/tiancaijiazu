...
@protocol WMPhotoBrowserDeletedelegate <NSObject>

- (void)WMPhotoBrowserDeleteTag:(NSInteger)tag;
...
@property(weak,nonatomic)id<WMPhotoBrowserDeletedelegate>delegate;
