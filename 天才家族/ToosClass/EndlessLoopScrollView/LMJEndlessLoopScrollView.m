...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    if(contentOffsetX >= (2 * SelfWidth_LMJ)) {
        ...
        if (self.Selecteditem) {
            _currentPageIndex = [self getNextPageIndexWithCurrentPageIndex:[self.Selecteditem integerValue]];
    ...
    if(contentOffsetX <= 0) {
        if (self.Selecteditem) {
              ...
              _currentPageIndex = [self getPreviousPageIndexWithCurrentPageIndex:[self.Selecteditem integerValue]];
             self.Selecteditem = nil;
